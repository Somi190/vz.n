...
def login():
    ...
    print "\033[1;97m◈◈◈◈[1]◈◈◈◈\x1b[1;93mPAKISTAN CLONE"  
    time.sleep(0.05)
    print "\033[1;97m◈◈◈◈[2]◈◈◈◈\x1b[1;93mBANGLADESH CLONE"
    time.sleep(0.05)
    print "\033[1;97m◈◈◈◈[3]◈◈◈◈\x1b[1;93mINDIAN CLONE"
    time.sleep(0.05)
    print "\033[1;97m◈◈◈◈[4]◈◈◈◈\x1b[1;93mSOMI YOUTUBE CHANNEL"
    time.sleep(0.05)
    print "\033[1;97m◈◈◈◈[5]◈◈◈◈\x1b[1;93mSOMI WHATAAP GROUP"
    time.sleep(0.05)
...
def pilih_crack():
    ...
    if Somi =="":
    	...
    	os.system("clear")
        print logo1
        print "\033[1;92mENTER ANY BANGLADESH NUMBER"+'\n \x1b[1;95m'
